...
<head>
  ...
  <title>Operadores Eliminados - Nexora Bolivia</title>
  @vite([
...
<body class="bg-gray-100">
  ...
  <section class="users-management">
    <div class="users-container">
      <h1 class="users-title">Operadores Eliminados</h1>

      <div class="action-buttons">
        <a href="{{ route('supervisor.operadores.index') }}" class="btn-action">← Volver a gestión</a>
      </div>
      ...
      <table class="users-table" id="deletedTable">
        ...
        <tbody>
          @forelse ($operadores as $empleado)
          <tr>
            ...
            <td class="actions">
              <form action="{{ route('supervisor.operadores.restore', $empleado->idEmpleado) }}" method="POST">
                @csrf
                @method('PUT')
          ...
          @empty
          <tr><td colspan="5" class="text-center p-4">No hay operadores eliminados</td></tr>
          @endforelse
          </tbody>
      </table>
    </div>

...
<head>
  ...
  <title>Editar Técnico - Nexora Bolivia</title>
  @vite([
...
<body>
  ...
  <section class="users-management">
    <div class="users-container form-edit-container">
      <h1 class="users-title">Editar Técnico</h1>

      <form action="{{ route('supervisor.tecnicos.update', $empleado->idEmpleado) }}" method="POST" class="space-y-4">
        @csrf
        @method('PUT')
        ...
        <div class="action-buttons mt-6">
          ...
          <a href="{{ route('supervisor.tecnicos.index') }}" class="btn-deleted">Cancelar</a>
        </div>
      </form>
    </div>
  </section>
